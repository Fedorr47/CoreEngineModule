...
namespace appEditor
{
    inline mathUtils::Vec3 GetTranslateGizmoAxisDirection(const rendern::TranslateGizmoState& gizmo, rendern::GizmoAxis axis) noexcept
    {
        switch (axis)
        {
        ...
        float viewportH)
    {
        ...
        const mathUtils::Vec3 axisWorld = GetTranslateGizmoAxisDirection(gizmo, axis);
