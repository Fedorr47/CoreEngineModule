...
export namespace rendern
{
    ...
    struct GameplayAnimationParameterBindingDesc
    {
        std::string gameplayParameter{};
        std::string animationParameter{};
    };

    struct GameplayAnimationEventTriggerBindingDesc
    {
        int actionKind{ 0 };
        std::string animationTrigger{};
    };

    struct GameplayAnimationNotifyBindingDesc
    {
        std::string animationEvent{};
        std::string gameplayEvent{};
    };

    struct GameplayAnimationBindingAsset
    {
        std::vector<GameplayAnimationParameterBindingDesc> parameterBindings{};
        std::vector<GameplayAnimationEventTriggerBindingDesc> actionTriggerBindings{};
        std::vector<GameplayAnimationNotifyBindingDesc> notifyBindings{};
    };
    ...
    [[nodiscard]] inline GameplayGraphAsset MakeDefaultHumanoidGameplayGraphAsset()
    {
        ...
        grounded.onUpdate = {
            GameplayGraphTaskDesc{ .name = "SyncInputToParameters" },
            GameplayGraphTaskDesc{ .name = "QueueActionRequestsFromInput" },
            GameplayGraphTaskDesc{ .name = "BuildCameraRelativeMove" },
            GameplayGraphTaskDesc{ .name = "ApplyCharacterMotor" },
            GameplayGraphTaskDesc{ .name = "FaceMovementForwardOnly" },
            GameplayGraphTaskDesc{ .name = "ComputeLocomotionMetrics" }
        };
    ...
    [[nodiscard]] inline GameplayAnimationBindingAsset MakeDefaultHumanoidGameplayAnimationBindingAsset()
    {
        GameplayAnimationBindingAsset asset{};
        asset.parameterBindings = {
            { .gameplayParameter = "moveX", .animationParameter = "MoveX" },
            { .gameplayParameter = "moveY", .animationParameter = "MoveY" },
            { .gameplayParameter = "planarSpeed", .animationParameter = "Speed" },
            { .gameplayParameter = "forwardSpeed", .animationParameter = "ForwardSpeed" },
            { .gameplayParameter = "rightSpeed", .animationParameter = "RightSpeed" },
            { .gameplayParameter = "turnDeltaYawDegrees", .animationParameter = "TurnDeltaYaw" },
            { .gameplayParameter = "isMoving", .animationParameter = "IsMoving" },
            { .gameplayParameter = "isRunning", .animationParameter = "IsRunning" },
            { .gameplayParameter = "wantsTurnInPlaceLeft", .animationParameter = "TurnInPlaceLeft" },
            { .gameplayParameter = "wantsTurnInPlaceRight", .animationParameter = "TurnInPlaceRight" },
            { .gameplayParameter = "actionBusy", .animationParameter = "ActionBusy" },
            { .gameplayParameter = "currentAction", .animationParameter = "CurrentAction" },
            { .gameplayParameter = "requestedActionKind", .animationParameter = "RequestedAction" }
        };

        asset.actionTriggerBindings = {
            { .actionKind = 1, .animationTrigger = "LightAttack" },
            { .actionKind = 2, .animationTrigger = "Interact" },
            { .actionKind = 3, .animationTrigger = "Jump" }
        };

        asset.notifyBindings = {
            { .animationEvent = "ActionBegin", .gameplayEvent = "Gameplay.Action.Begin" },
            { .animationEvent = "ActionEnd", .gameplayEvent = "Gameplay.Action.End" },
            { .animationEvent = "LightAttackBegin", .gameplayEvent = "Gameplay.Action.Begin" },
            { .animationEvent = "LightAttackEnd", .gameplayEvent = "Gameplay.Action.End" },
            { .animationEvent = "InteractBegin", .gameplayEvent = "Gameplay.Action.Begin" },
            { .animationEvent = "InteractEnd", .gameplayEvent = "Gameplay.Action.End" },
            { .animationEvent = "JumpBegin", .gameplayEvent = "Gameplay.Action.Begin" },
            { .animationEvent = "JumpEnd", .gameplayEvent = "Gameplay.Action.End" },
            { .animationEvent = "Footstep", .gameplayEvent = "Gameplay.Footstep" }
        };
        return asset;
    }
}
